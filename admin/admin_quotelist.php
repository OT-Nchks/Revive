  ...
  <div class="container p-5 align-center">
   ...
   <section class="music" id="main2" style="margin-top:7rem; margin-left:18rem;">
          ...
          <div class="tab__content tab__content--active">
            ...
            <a href="admin_addquotes.php"><i class="ri-arrow-right-s-line" style="border:2px solid white; border-radius:50%; padding:3px; font-weight:600; margin-left:1rem;"></i></a>
            <h5 style="font-size:20px; margin-left:1rem;" class="card__title">Add Quotes</h5>
        ...
        <tr>
            <!-- <th><?php echo $T; ?></th> -->
            <td><img src="uploads/imageupload/<?php echo $q['quote_image'];?>" width="50"> <?php echo $q['quote_author']; ?></td>
            <td><?php echo $q['quote_message']; ?></td>
            <td><strong><?php echo $q['qcat_name']; ?><strong></td>
            <td>
                <a href="edit_quotes.php?id=<?php echo $q['quote_id']; ?>" class="status edit">Edit</a> 
                <a onclick="return confirm('Are you sure you want to delete?')" href="deletequotes.php?id=<?php echo $q['quote_id']; ?>" class="status delete">Delete</a>
            </td>
        </tr>
        <?php
            }
