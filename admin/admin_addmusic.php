...
<style>
   ...
   *{
   ...
   <section class="music" id="main2" style="margin-top:6rem;">
            ...
            <a href="admin_playlist.php"><i class="ri-arrow-left-s-line nav__link" style="border:2px solid white; border-radius:50%; padding:3px; font-weight:600;"></i></a>
...
<div class="container">
      <h2 class="form-title" style="font-family:montserrat;">Upload Tracks</h2>
      <form action="process/adminadd.php" method="post" enctype="multipart/form-data" id="uploadForm">
      ...
      <?php
        ...
        <div class="main-user-info">
          <div class="user-input-box">
            ...
            <input type="text" name="playlistname"class="form-control" id="playlistName">
          </div>
          ...
          <label for="trackduration">Track Duration</label>
           <input type="time" name="trackduration" id="trackduration">
          </div>
          ...
          <div class="user-input-box">
          <label for="customFile">Upload Audio File</label>
        ...
        <button type="submit" name="uploadBtn" value="upload" class="btn"><span style="color:#fff; font-family:poppins;">Upload Music</span></button>
        </div>
      </form>
    </div>
          </div>
