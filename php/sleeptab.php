      ...
      <main class="main">
         ...
         <!----- MUSIC TAB STARTS HERE ----->
               ...
               <section class="music" id="main2">
                  ...
                  <div class="tab__content tab__content--active playlist" data-tab="6">



                  <!--playlist 1-->
                  <h3 class="card__title2">Cozy Sleep Stories</h3>
      
      <div class="movie__swiper swiper">
         <div class="swiper-wrapper">
               
                        <?php
                        foreach ($playlists["Cozy Sleep Stories"] as $track){ 
                           $imageFile = "../admin/uploads/imageupload/{$track['track_image']}";
                           $audioFile = "../admin/uploads/audioupload/{$track['track_audio']}";
                     ?>   

               <article class="card__article swiper-slide" data-img-src="<?php echo $imageFile; ?>" data-title="" data-artist="" data-audio-src="<?php echo $audioFile; ?>">
         ...
         <i class="ri-pause-circle-line pause-btn" style="display:none;"></i>
                  ...
                  <h3 class="music__name"><?php echo $track['track_name'];?></h3>
                     <span class="music__category"></span>
                  </div> 
               </a>
               <button>
             ...
             <?php
                     ...
                     <!--playlist2-->
                  <h3 class="card__title2">Narrated By</h3>
      
                  <div class="movie__swiper swiper">
                     <div class="swiper-wrapper">

                                  <?php
                                    foreach ($playlists["Narrated By"]as $track){ 
                                       $imageFile = "../admin/uploads/imageupload/{$track['track_image']}";
                                       $audioFile = "../admin/uploads/audioupload/{$track['track_audio']}";
                                 ?>   
