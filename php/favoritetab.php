...
$music = new Music();
$liked_tracks = $music->get_user_liked_tracks($user_id);
...
<style>
    * {
    ...
    .table__header {
        width: 100%;
        height: 10%;
        background-color: rgba(108, 130, 169, 0.55);
        padding: .7rem 1rem;
        display: flex;
    ...
    thead th {
        ...
        top: 0;
        left: 0;
        background-color: rgba(128, 135, 159, 0.9);
        cursor: pointer;
    ...
    .export__file .export__file-btn {
        ...
        width: 2rem;
        height: 2rem;
        background: #fff6 url(../admin/assets/images/export.png) center / 80% no-repeat;
        border-radius: 50%;
        transition: .2s ease-in-out;
    }
  ...
  <div class="container p-5 align-center">
   ...
   <section class="music" id="main2" style="margin-top:7rem; margin-left:18rem;">
          ...
          <div class="tab__content tab__content--active">
            ...
            <a href="profiletab.php"><i class="ri-arrow-left-s-line" style="border:2px solid white; border-radius:50%; padding:3px; font-weight:600; margin-left:1rem;"></i></a>
            <h5 style="font-size:20px; margin-left:1rem;" class="card__title">List of Favorite Tracks</h5>
        ...
        <section class="table__header" style="font-size:16px;">
            ...
            <div class="input-group">
                ...
                <img src="../admin/assets/images/search.png" alt="">
            </div>
            ...
            <div class="export__file">
                ...
                <div class="export__file-options">
                    ...
                    <label for="export-file" id="toPDF">PDF <img src="../admin/assets/images/pdf.png" alt=""></label>
                </div>
            </div>
        </section>
