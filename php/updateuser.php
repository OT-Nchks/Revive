    ...
    <section class="music" id="main2" style="margin-bottom:-1rem;">
        <div class="tab__content tab__content--active" data-tab="6">
            ...
            <div class="container">
                ...
                <div class="input-box">
                    <form class="form-container" id="updateForm" method="post" action="../process/process_updateuser.php">
                        <div class="row" style="margin-top:1rem;">
                            <label for="firstname">Full Name</label>
                            <input type="text" class="form-control" name="fullname" value="<?php echo htmlspecialchars($user_details['user_fname']."  ".$user_details['user_lname']);?>"/>
                        </div>

                        <div class="row" style="margin-top:0.8rem;">
                            <label for="email">Email Address</label>
                            <input type="text" class="form-control" name="email" value="<?php echo htmlspecialchars($user_details['user_email']);?>" />
                        </div>
